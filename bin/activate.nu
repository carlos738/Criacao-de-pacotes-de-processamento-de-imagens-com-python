...
export-env {
    ...
    let virtual_env = '/home/machine/Documentos/BOOTCAMP-SUZANO-PYTHON DEVELOPER/Criacao-de-pacotes-de-processamento-de-imagens-com-python/simple-calculator/venv'
    let bin = 'bin'
